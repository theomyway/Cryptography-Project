...
namespace Crypto_Project__Algorithms_
{
    public partial class Form1 : Form
    {
        ...
        // Encrypt a byte array using RSA encryption
        ...
        // Decrypt a byte array using RSA decryption
        ...
        private void button9_Click(object sender, EventArgs e)    //--------------Triple encryption button
        {
            textBox4.Text = textBox1.Text;
        ...
        //------------------------------------------------------------TRIPLE DES-------------->>>>>>>>>>>>>>>
        static byte[] TripleDESEncrypt(byte[] data, byte[] key)
        {
